...
// test working
 //particleSystem.geometry.vertices[0].x=0;
// particleSystem.geometry.vertices[0].y=41;
particleSystem.geometry.vertices[0].name="lightbox";
particleSystem.geometry.vertices[1].name="l";
particleSystem.geometry.vertices[2].name="lb";
